(function() {
  ...
  path.projection(d3.geo.equirectangular().scale(20000).translate([3200, -1500]));
  var region = d3.select("#chart").append("svg:svg").attr("id", "region").attr("class", "Blues").attr('width', '450px').attr('height', '400px');
